...
public class PageMagazin extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page__magaz);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.PageMain:
                break;
            case R.id.PageBD:
                Intent intent2 = new Intent(this, PageBD.class);
